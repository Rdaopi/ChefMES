...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    // Invoice Import
    invoiceImportSubtitle: 'Upload an XML restaurant invoice and preview parsed line items with simple trading signals.',
    invoiceLineItems: 'Invoice Line Items',
    tradingFromInvoice: 'Trading from Invoice',
    tradingFromInvoiceDesc: 'Ingredients are automatically extracted from invoice lines and mapped into a trading view.',
    parsedIngredientCount: 'Parsed ingredient count',
    ...
    vat: 'VAT',
    contract: 'Contract',
    unableToReadFile: 'Unable to read invoice file.',
    unableToParseXml: 'Unable to parse XML invoice. Please upload a valid XML file.',
    noFileSelected: 'No file selected.',
    noPricedIngredients: 'No ingredients with price available',
    noPricedIngredientsHint: 'Import at least one invoice before creating recipes. Without prices, production costs will always be €0.00.',
    missingPrice: 'missing price',
    zeroCostHint: 'Cost €0 — import invoices to get real prices',
  },
  it: {
    appName: 'ChefMES',
    profileName: 'F&B Manager',
    ...
    // Invoice Import
    invoiceImportSubtitle: 'Carica una fattura di ristorante in formato XML e visualizza gli articoli analizzati con semplici segnali di trading.',
    invoiceLineItems: 'Righe Fattura',
    tradingFromInvoice: 'Trading dalla Fattura',
    tradingFromInvoiceDesc: 'Gli ingredienti vengono estratti automaticamente dalle righe della fattura e mappati in una vista di trading.',
    parsedIngredientCount: 'Ingredienti rilevati',
    marketSignals: 'Segnali di mercato',
    active: 'attivi',
    tradingView: 'Vista trading',
    ...
    vat: 'IVA',
    contract: 'Contratto',
    unableToReadFile: 'Impossibile leggere il file della fattura.',
    unableToParseXml: 'Impossibile analizzare la fattura XML. Si prega di caricare un file XML valido.',
    noFileSelected: 'Nessun file selezionato.',
    noPricedIngredients: 'Nessun ingrediente con prezzo disponibile',
    noPricedIngredientsHint: 'Importa almeno una fattura prima di creare ricette. Senza prezzi, i costi di produzione saranno sempre €0.00.',
    missingPrice: 'prezzo mancante',
    zeroCostHint: 'Costo €0 — importa fatture per ottenere prezzi reali',
  },
  fr: {
    appName: 'ChefMES',
    ...
    // Invoice Import
    invoiceImportSubtitle: 'Téléchargez une facture de restaurant au format XML et prévisualisez les articles analysés avec des signaux commerciaux simples.',
    invoiceLineItems: 'Lignes de Facture',
    tradingFromInvoice: 'Trading depuis la Facture',
    tradingFromInvoiceDesc: 'Les ingrédients sont automatiquement extraits des lignes de facture et mappés dans une vue de trading.',
    parsedIngredientCount: 'Ingrédients détectés',
    marketSignals: 'Signaux de marché',
    active: 'actifs',
    ...
    vat: 'TVA',
    contract: 'Contrat',
    unableToReadFile: 'Impossible de lire le fichier de facture.',
    unableToParseXml: 'Impossible d\'analyser la facture XML. Veuillez télécharger un fichier XML valide.',
    noFileSelected: 'Aucun fichier sélectionné.',
    noPricedIngredients: 'Aucun ingrédient avec un prix disponible',
    noPricedIngredientsHint: 'Importez au moins une facture avant de créer des recettes. Sans prix, les coûts de production seront toujours €0.00.',
    missingPrice: 'prix manquant',
    zeroCostHint: 'Coût €0 — importez des factures pour obtenir des prix réels',
  },
  de: {
    appName: 'ChefMES',
    profileName: 'F&B Manager',
    ...
    // Invoice Import
    invoiceImportSubtitle: 'Laden Sie eine Restaurantrechnung im XML-Format hoch und zeigen Sie analysierte Positionen mit einfachen Handelssignalen an.',
    invoiceLineItems: 'Rechnungspositionen',
    tradingFromInvoice: 'Trading aus der Rechnung',
    tradingFromInvoiceDesc: 'Zutaten werden automatisch aus den Rechnungspositionen extrahiert und in eine Handelsansicht übertragen.',
    parsedIngredientCount: 'Erkannte Zutaten',
    marketSignals: 'Marktsignale',
    active: 'aktiv',
    tradingView: 'Handelsansicht',
    ...
    vat: 'MwSt.',
    contract: 'Vertrag',
    unableToReadFile: 'Die Rechnungsdatei konnte nicht gelesen werden.',
    unableToParseXml: 'Die XML-Rechnung konnte nicht verarbeitet werden. Bitte laden Sie eine gültige XML-Datei hoch.',
    noFileSelected: 'Keine Datei ausgewählt.',
    noPricedIngredients: 'Keine Zutaten mit verfügbarem Preis',
    noPricedIngredientsHint: 'Importieren Sie mindestens eine Rechnung, bevor Sie Rezepte erstellen. Ohne Preise sind die Produktionskosten immer €0.00.',
    missingPrice: 'Preis fehlt',
    zeroCostHint: 'Kosten €0 — importieren Sie Rechnungen für echte Preise',
  },
};
